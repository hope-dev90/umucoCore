    ...
    <Layout>
      <div className="history-page">
        ...
        <div className="history-stats">
          ...
          <div className="history-stat-card">
            <h2>{historyItems.filter((item) => item.type === 'Audio').length}</h2>
            <span>{t('history.statAudioSessions')}</span>
          </div>
          <div className="history-stat-card">
            <h2>{historyItems.filter((item) => item.type === 'Article').length}</h2>
          ...
          {historyItems.length === 0 ? (
            <div className="history-item">
              <div className="history-content">
                ...
                <span className="history-type-badge">Start exploring to build history.</span>
              </div>
            </div>
