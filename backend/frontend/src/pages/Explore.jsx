...
const EXPLORE_FALLBACK_TRANSLATIONS = {
  "Ingoro y'Ubwami ya Nyanza": {
    en: { category: 'Royal', title: 'Royal Palace of Nyanza', desc: "A reconstructed royal palace showing Rwanda's architecture, ceremonies, and daily court life." },
    fr: { category: 'Royal', title: 'Palais royal de Nyanza', desc: "Un palais royal reconstruit qui presente l'architecture, les ceremonies et la vie quotidienne de la cour rwandaise." },
  },
  "Intore – Umubyino w'Ubutwari": {
    en: { category: 'Performance', title: 'Intore - Dance of Bravery', desc: 'A powerful Intore tradition of discipline, bravery, rhythm, and ceremonial movement.' },
    fr: { category: 'Performance', title: 'Intore - danse de bravoure', desc: 'Une tradition intore de discipline, de bravoure, de rythme et de mouvement ceremonial.' },
  },
  "Inanga – Umutima w'Umuziki Nyarwanda": {
    en: { category: 'Music', title: 'Inanga - Heart of Rwandan Music', desc: 'Hear inanga, ikembe, and drums as they carried memory through royal courts and villages.' },
    fr: { category: 'Musique', title: "Inanga - coeur de la musique rwandaise", desc: "Ecoutez l'inanga, l'ikembe et les tambours qui portaient la memoire dans les cours royales et les villages." },
  },
  "Imigani – Inkuru zivugwa ku Muriro": {
    en: { category: 'Folktales', title: 'Imigani - Fireside Stories', desc: 'Enter Rwanda’s oral tradition of proverbs, stories, and lessons shared across generations.' },
    fr: { category: 'Contes', title: 'Imigani - recits du feu', desc: "Entrez dans la tradition orale rwandaise des proverbes, recits et lecons transmis de generation en generation." },
  },
  "Kigeli IV Rwabugiri – Umwami w'Intwari": {
    en: { category: 'Royal', title: 'Kigeli IV Rwabugiri - Warrior King', desc: 'One of Rwanda’s strongest kings, remembered for expansion, military campaigns, and administrative reform.' },
    fr: { category: 'Royal', title: 'Kigeli IV Rwabugiri - roi guerrier', desc: "L'un des rois les plus puissants du Rwanda, connu pour l'expansion, les campagnes militaires et les reformes." },
  },
  "Ubwiru – Imihango y'Urukiko rw'Ubwami": {
    en: { category: 'Rituals', title: 'Ubwiru - Royal Court Rituals', desc: 'Sacred rituals and protected knowledge that guided the life of the royal court.' },
    fr: { category: 'Rituels', title: 'Ubwiru - rituels de la cour royale', desc: 'Rituels sacres et savoir protege qui guidaient la vie de la cour royale.' },
  },
  "Imigani – Inkuru zo ku Muriro": {
    en: { category: 'Folktales', title: 'Imigani - Stories by the Fire', desc: 'Oral stories elders used to teach children wisdom, humor, memory, and good conduct.' },
    fr: { category: 'Contes', title: 'Imigani - histoires autour du feu', desc: 'Recits oraux que les anciens utilisaient pour transmettre sagesse, humour, memoire et conduite.' },
  },
  "Ibyivugo – Ibisigo by'Ubutwari": {
    en: { category: 'Poetry', title: 'Ibyivugo - Warrior Praise Poetry', desc: 'Self-praise poems performed by warriors and hunters to celebrate courage and achievement.' },
    fr: { category: 'Poesie', title: 'Ibyivugo - poesie de bravoure', desc: 'Poemes de louange personnelle declames par guerriers et chasseurs pour celebrer le courage.' },
  },
  "Inzira z'Ubwenge – Ibisakuzo n'Ubuhanga": {
    en: { category: 'Wisdom', title: 'Paths of Wisdom - Riddles and Insight', desc: 'Traditional riddles and sayings used to sharpen memory, reasoning, and cultural knowledge.' },
    fr: { category: 'Sagesse', title: 'Chemins de sagesse - devinettes et savoir', desc: 'Devinettes et proverbes traditionnels pour aiguiser la memoire, le raisonnement et la culture.' },
  },
  "Ingoma – Ingoma Zera z'Ubwami": {
    en: { category: 'Music', title: 'Ingoma - Sacred Royal Drums', desc: 'Royal drums used in ceremonies, announcements, and celebrations at the heart of court life.' },
    fr: { category: 'Musique', title: 'Ingoma - tambours royaux sacres', desc: 'Tambours royaux utilises dans les ceremonies, annonces et celebrations de la cour.' },
  },
  "Umuvugo – Indirimbo z'Ishimwe": {
    en: { category: 'Music', title: 'Umuvugo - Songs of Praise', desc: 'Traditional songs praising kings, heroes, and meaningful events in community memory.' },
    fr: { category: 'Musique', title: 'Umuvugo - chants de louange', desc: 'Chants traditionnels louant rois, heros et evenements marquants de la memoire collective.' },
  },
  "Ubudehe – Ubufatanye bw'Abaturage": {
    en: { category: 'Community', title: 'Ubudehe - Community Cooperation', desc: 'An old practice of shared work and mutual help that shaped Rwandan community life.' },
    fr: { category: 'Communaute', title: 'Ubudehe - cooperation communautaire', desc: "Ancienne pratique de travail partage et d'entraide qui a faconne la vie communautaire rwandaise." },
  },
  "Agaseke – Ibiseke by'Amahoro": {
    en: { category: 'Crafts', title: 'Agaseke - Peace Baskets', desc: 'Carefully woven baskets rich in cultural meaning, used in ceremonies, gifts, and daily life.' },
    fr: { category: 'Artisanat', title: 'Agaseke - paniers de paix', desc: 'Paniers finement tisses, riches de sens culturel, utilises dans les ceremonies, les cadeaux et la vie quotidienne.' },
  },
  "Inanga – Ikinanga cy'u Rwanda": {
    en: { category: 'Music', title: 'Inanga - Rwanda’s String Instrument', desc: 'A signature traditional instrument played in royal courts and village ceremonies.' },
    fr: { category: 'Musique', title: "Inanga - instrument a cordes du Rwanda", desc: 'Instrument traditionnel emblematique joue dans les cours royales et les ceremonies villageoises.' },
  },
  "Ingabo – Abarinzi b'Ubwami": {
    en: { category: 'History', title: 'Ingabo - Guardians of the Kingdom', desc: 'Brave royal guards who protected the king and helped maintain security across the kingdom.' },
    fr: { category: 'Histoire', title: 'Ingabo - gardiens du royaume', desc: 'Braves gardes royaux qui protegeaient le roi et contribuaient a la securite du royaume.' },
  },
};
...
export default function Explore() {
  ...
  const localizedHeritageItems = useMemo(
    () => heritageItems.map((item) => localizeExploreFallbackItem(item, language)),
    ...
    fetch(apiUrl('/api/heritage'), { signal: controller.signal })
      ...
      .then(data => {
        if (data.items && data.items.length > 0) {
          ...
          setHeritageItems(apiMapped);
        } else {
          setHeritageItems(FALLBACK_ITEMS);
        }
      })
      .catch(() => setHeritageItems(FALLBACK_ITEMS))
  ...
  useEffect(() => {
    ...
    try {
      ...
      const story = localizedHeritageItems.find(h => String(h.id) === String(payload.itemId));
      if (story) {
  ...
  const filteredHeritageItems = localizedHeritageItems.filter(item => {
